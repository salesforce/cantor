...
public class Constants {
    ...
    public static final String CANTOR_MULTICLOUDJ_ACCESS_KEY_ID = "access-key-id";
    public static final String CANTOR_MULTICLOUDJ_SECRET_ACCESS_KEY = "secret-access-key";
    public static final String CANTOR_MULTICLOUDJ_SESSION_TOKEN = "session-token";
