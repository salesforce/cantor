...
public interface Functions {
     ...
     */
    default void store(final String function, final String body) throws IOException {
     ...
     * @throws IOException exception thrown from the underlying storage implementation
     */
    void store(String function, byte[] body) throws IOException;
     ...
     * @throws IOException exception thrown from the underlying storage implementation
     */
    void run(String function, Context context, Map<String, String> params) throws IOException;
}
