...
public abstract class AbstractBaseArchiverOnS3 {
    ...
    public AbstractBaseArchiverOnS3(final CantorArchiver fileArchiver) {
        this(fileArchiver, 0);
    }

    public AbstractBaseArchiverOnS3(final CantorArchiver fileArchiver, final long chunkMillis) {
